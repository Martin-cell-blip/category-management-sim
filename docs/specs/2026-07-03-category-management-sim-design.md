# 设计文档:京东采销·家居日用品类经营模拟盘(category-management-sim)

> 日期:2026-07-03 | 状态:已获用户批准的设计,待实施
> 作者:马准名(与 Claude Code 协作)
> 用途:京东 2027 TET 管培生(综合方向→采销)求职作品
...
- **中国市场判断层**:由《家居日用品类行业研究报告》承担(独立作品,位于 D:\京东TET管培生_申请材料\行研_家居日用品类\),提供价格带 5-30 元、白牌格局、利润倒挂、"份额行业"等中国语境结论。
