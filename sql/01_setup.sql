-- 01_setup.sql — 品类经营底表
-- 口径纪律:仅取已送达(delivered)订单;主品类 housewares,对照品类 bed_bath_table / furniture_decor
...
WHERE o.order_status = 'delivered'
  AND t.product_category_name_english IN ('housewares', 'bed_bath_table', 'furniture_decor');
